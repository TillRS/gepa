...
The OpenRouter technical smoke script uses the named July 31 DeepSeek release
through DeepInfra FP8 with fallbacks disabled. These smoke runs do not establish
the identity or behavior of the local vLLM campaign.
